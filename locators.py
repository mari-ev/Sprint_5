...
class RegistrationPageLocators:
    ...
    LOGIN_REGISTRATION_BUTTON = (By.CLASS_NAME, "buttonSecondary")
    ...
    LOGOUT_BUTTON = (
        By.XPATH,
        "//button[@class='spanGlobal btnSmall' and @type='button' and contains(text(), 'Выйти')]",
    )
    LOGIN_SUBMIT_BUTTON = (
        By.XPATH,
...
class AdCreationLocators:
    """Локаторы элементов для создания объявления"""
